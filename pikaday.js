...
var Pikaday = init(this, moment, function(moment){
    'use strict';
...
//        },
        ...
        renderDay = function(opts){
            ...
            if (opts.highlightGroup != null){
                arr.push(opts.highlightGroup);
            }
            if (opts.isHighlighted != null){
...
function init(root, t_moment, factory){
    'use strict';
    ...
    if (typeof exports === 'object'){
        ...
        return module.exports = factory(moment);
        ...
        return factory(t_moment || root.moment);
    }
}
